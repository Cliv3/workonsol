  ...
  return (
    ...
    <header className="container mx-auto px-4 py-12">
      ...
      <div className="flex justify-center gap-4 flex-wrap">
        <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-bold flex items-center gap-2 shadow-lg transform hover:scale-105 transition-transform">
    ...
    <footer className="container mx-auto px-4 py-8">
      <div className="flex justify-center gap-6 mb-4">
        <div className="flex gap-4">
          <a href="#" className="bg-amber-50 hover:bg-amber-100 p-3 rounded-full shadow-lg transform hover:scale-110 transition-transform">
